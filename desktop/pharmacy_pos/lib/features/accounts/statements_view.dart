...
class _AccountsDashboardState extends State<AccountsDashboard> {
  ...
  @override Widget build(BuildContext context) => Column(children: [
    ...
    Expanded(child: _loading ? const AppLoadingState() : _error != null ? AccountsError(_error!, onRetry: _load) : ListView(padding: const EdgeInsets.all(20), children: [
...
class _GeneralLedgerViewState extends State<GeneralLedgerView> {
  ...
  Widget _ledgerBody(){if(_loading)return const AppLoadingState();if(_error!=null)return AccountsError(_error!,onRetry:_load);if(_ledger==null)return AppEmptyState(title: 'Select an account.');final entries=_ledger!['entries'] as Map<String,dynamic>;final rows=(entries['items'] as List<dynamic>? ?? []).cast<Map<String,dynamic>>();return Column(children:[
