        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenericName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    TradePrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ReorderLevel = table.Column<int>(type: "integer", nullable: false),
                    MaximumDiscountPercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StockMovements_QuantitySign", "\"Quantity\" <> 0 AND ((\"MovementType\" IN (1, 2, 4, 6, 8) AND \"Quantity\" > 0) OR (\"MovementType\" IN (3, 5, 7, 9, 10, 11) AND \"Quantity\" < 0))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventory_BranchId_ProductId_ProductBatchId",
                table: "Inventory",
                columns: new[] { "BranchId", "ProductId", "ProductBatchId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_BranchId_ReorderLevel",
                table: "Inventory",
                columns: new[] { "BranchId", "ReorderLevel" },
                filter: "\"QuantityInStock\" < \"ReorderLevel\"");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_BranchId_CreatedAt",
                table: "StockMovements",
                columns: new[] { "BranchId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_BranchId_ProductId_ProductBatchId",
                table: "StockMovements",
                columns: new[] { "BranchId", "ProductId", "ProductBatchId" });
